...
if( NOT MULLE_ABA_LIBRARY)
   find_library( MULLE_ABA_LIBRARY NAMES
   ...
   if( NOT MULLE_ABA_LIBRARY AND NOT DEPENDENCY_IGNORE_SYSTEM_LIBARIES)
      find_library( MULLE_ABA_LIBRARY NAMES
         ${CMAKE_STATIC_LIBRARY_PREFIX}mulle-aba${CMAKE_DEBUG_POSTFIX}${CMAKE_STATIC_LIBRARY_SUFFIX}
         ${CMAKE_STATIC_LIBRARY_PREFIX}mulle-aba${CMAKE_STATIC_LIBRARY_SUFFIX}
         mulle-aba
   ...
   if( MULLE_ABA_LIBRARY)
      ...
      #
      list( APPEND DEPENDENCY_LIBRARIES ${MULLE_ABA_LIBRARY})
      #
      ...
      foreach( _TMP_MULLE_ABA_NAME "mulle-aba")
         ...
         if( IS_DIRECTORY "${_TMP_MULLE_ABA_DIR}")
            ...
            #
            include( "${_TMP_MULLE_ABA_DIR}/DependenciesAndLibraries.cmake" OPTIONAL)
            #
            ...
            include( "${_TMP_MULLE_ABA_DIR}/Definitions.cmake" OPTIONAL)
            list( APPEND INHERITED_DEFINITIONS ${MULLE_ABA_DEFINITIONS})
            break()
         else()
            message( STATUS "${_TMP_MULLE_ABA_DIR} not found")
         endif()
      endforeach()
   else()
